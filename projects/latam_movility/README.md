...
3. Cleaned and standardized datasets for consistency.
4. Merged data sources using city-level identifiers.
5. Conducted exploratory analysis to identify patterns and trends.
6. Evaluated the relationship between congestion levels and economic performance indicators.
...
- Significant differences were observed across cities, highlighting opportunities for targeted infrastructure investments.
...
- Identify meaningful patterns through exploratory analysis.
